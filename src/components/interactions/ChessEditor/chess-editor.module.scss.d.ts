declare const styles: {
  ...
  readonly editorCommandbarTop: string;
  readonly editorCommandbarSeparator: string;
  readonly editorCommandbarPanel: string;
  readonly editorMainRow: string;
  readonly editorBoardCol: string;
