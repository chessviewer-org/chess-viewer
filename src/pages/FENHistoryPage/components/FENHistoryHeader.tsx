      ...
      <header className="shrink-0 bg-surface border-b border-border animate-pageEnter">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 sm:gap-4">
              <button
                type="button"
                onClick={handleBack}
                className="flex items-center gap-2 sm:gap-2.5 px-3 sm:px-4 py-2 hover:bg-surface-hover rounded-xl transition-colors duration-200 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
                aria-label="Go back"
              >
                <ArrowLeft
                  className="w-4 h-4 sm:w-5 sm:h-5 text-accent group-hover:text-text-primary-hover transition-colors duration-200"
                  aria-hidden="true"
                />
              ...
              <div className="flex items-center gap-2 sm:gap-2.5">
                <Clock
                  className="w-5 h-5 sm:w-6 sm:h-6 text-text-secondary animate-iconBounceIn"
                  aria-hidden="true"
                />
            ...
            {currentDataLength > 0 && (
              <button
                ...
                className="flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-error hover:bg-error/10 rounded-xl transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
              >
                <Trash2
        ...
        <div className="px-4 sm:px-6 pb-2 sm:pb-2.5">
          <div
            ...
            className="flex items-center gap-2 border-t border-border/40 pt-2 sm:pt-2.5"
          >
            <button
              type="button"
              role="tab"
              ...
              className={`flex-1 flex items-center justify-center gap-1.5 px-3 py-2 sm:py-2.5 rounded-lg text-xs sm:text-sm font-bold transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent ${
                activeTab === 'active'
