...
export const FENHistoryGridItem: React.FC<FENHistoryGridItemProps> = memo(({
  ...
  return (
    <div
      className="bg-surface border border-border rounded-xl overflow-hidden hover:shadow-lg hover:shadow-accent/5 hover:border-accent/30 transition-all duration-200 group flex flex-col min-h-50 animate-cardReveal"
