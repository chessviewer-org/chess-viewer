import { createLucideIcon } from './createIcon';
export type { LucideIcon } from './createIcon';

export const Accessibility = createLucideIcon('accessibility', [
...
export const AlertCircle = createLucideIcon('circle-alert', [
  ['circle', { cx: '12', cy: '12', r: '10', key: '1mglay' }],
  ['line', { x1: '12', x2: '12', y1: '8', y2: '12', key: '1pkeuh' }],
  ['line', { x1: '12', x2: '12.01', y1: '16', y2: '16', key: '4dfq90' }]
]);

export const AlertTriangle = createLucideIcon('triangle-alert', [
  [
    'path',
    {
...
export const Boxes = createLucideIcon('boxes', [
  [
    'path',
    {
...
export const CheckCircle = createLucideIcon('circle-check-big', [
  ['path', { d: 'M21.801 10A10 10 0 1 1 17 3.335', key: 'yps3ct' }],
  ['path', { d: 'm9 11 3 3L22 4', key: '1pflzl' }]
]);

export const CheckCircle2 = createLucideIcon('circle-check', [
  ['circle', { cx: '12', cy: '12', r: '10', key: '1mglay' }],
  ['path', { d: 'm9 12 2 2 4-4', key: 'dzmm74' }]
]);

export const ChessKing = createLucideIcon('chess-king', [
  [
    'path',
    {
...
export const Code2 = createLucideIcon('code-xml', [
...
export const Diamond = createLucideIcon('diamond', [
  [
    'path',
    {
...
export const FileImage = createLucideIcon('file-image', [
  [
    'path',
    {
...
export const Filter = createLucideIcon('funnel', [
  [
    'path',
    {
...
export const Fingerprint = createLucideIcon('fingerprint-pattern', [
...
export const Gem = createLucideIcon('gem', [
...
export const GitCommitHorizontal = createLucideIcon('git-commit-horizontal', [
  ['circle', { cx: '12', cy: '12', r: '3', key: '1v7zrd' }],
  ['line', { x1: '3', x2: '9', y1: '12', y2: '12', key: '1dyftd' }],
  ['line', { x1: '15', x2: '21', y1: '12', y2: '12', key: 'oup4p8' }]
]);

export const GitPullRequest = createLucideIcon('git-pull-request', [
...
export const HardDrive = createLucideIcon('hard-drive', [
...
export const HeartHandshake = createLucideIcon('heart-handshake', [
  [
    'path',
    {
...
export const HelpCircle = createLucideIcon('circle-question-mark', [
  ['circle', { cx: '12', cy: '12', r: '10', key: '1mglay' }],
...
export const Home = createLucideIcon('house', [
...
export const Hourglass = createLucideIcon('hourglass', [
...
export const KeyRound = createLucideIcon('key-round', [
  [
    'path',
    {
...
export const Library = createLucideIcon('library', [
...
export const ListPlus = createLucideIcon('list-plus', [
...
export const Loader2 = createLucideIcon('loader-circle', [
...
export const LogIn = createLucideIcon('log-in', [
  ['path', { d: 'm10 17 5-5-5-5', key: '1bsop3' }],
  ['path', { d: 'M15 12H3', key: '6jk70r' }],
  ['path', { d: 'M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4', key: 'u53s6r' }]
]);

export const LogOut = createLucideIcon('log-out', [
...
export const MailCheck = createLucideIcon('mail-check', [
  [
    'path',
    {
...
export const MessageSquare = createLucideIcon('message-square', [
  [
    'path',
    {
...
export const MousePointer = createLucideIcon('mouse-pointer', [
...
export const Redo2 = createLucideIcon('redo-2', [
...
export const Repeat2 = createLucideIcon('repeat-2', [
...
export const Share2 = createLucideIcon('share-2', [
...
export const ShieldAlert = createLucideIcon('shield-alert', [
  [
    'path',
    {
      d: 'M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z',
...
export const ShieldX = createLucideIcon('shield-x', [
  [
    'path',
    {
      d: 'M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z',
...
export const Sliders = createLucideIcon('sliders-vertical', [
...
export const Undo2 = createLucideIcon('undo-2', [
...
export const UserCircle = createLucideIcon('circle-user', [
  ['circle', { cx: '12', cy: '12', r: '10', key: '1mglay' }],
...
export const XCircle = createLucideIcon('circle-x', [
  ['circle', { cx: '12', cy: '12', r: '10', key: '1mglay' }],
